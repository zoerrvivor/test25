...
namespace Test25.Core.Gameplay.Entities
{
    public class Tank : GameObject
    {
        ...
        public static void SetDialogueManager(DialogueManager manager) => _dialogueManager = manager;
        ...
        public void AdjustAim(float delta)
        {
            ...
            if (change > 0)
            {
                ...
                while (_accumulatedAngleChange >= threshold)
                {
                    ...
                    SoundManager.PlaySound("angle_tick");
                }
            }
        }
