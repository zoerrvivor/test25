...
namespace Test25.Gameplay.Entities
{
    public class TankDebris
    {
        ...
        public float MaxLifetime = 30f; // Debris lasts for a while
        ...
        {
            spriteBatch.Draw(Texture, Position, null, Color.White, Rotation, _origin, 1f, SpriteEffects.None, 0f); // Render white (burned look?) or original color? User said "smoking junk", maybe darken it?
        }
    }
}
