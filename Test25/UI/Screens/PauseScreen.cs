...
namespace Test25.UI.Screens
{
    public class PauseScreen
    {
        ...
        private void InitializeGui()
        {
            ...
            // Resume Button
            Button resumeBtn = new Button(_graphicsDevice, new Rectangle(panelRect.X + 50, panelRect.Y + 80, 200, 40),
                "Resume Game", _font);
            resumeBtn.OnClick += (e) => IsResumeSelected = true;
            _guiManager.AddElement(resumeBtn);

            // Exit Button
            Button exitBtn = new Button(_graphicsDevice, new Rectangle(panelRect.X + 50, panelRect.Y + 150, 200, 40),
                "Exit to Menu", _font);
