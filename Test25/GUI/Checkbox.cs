...
namespace Test25.GUI
{
    public class Checkbox : GuiElement
    {
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            ...
            if (IsChecked)
            {
                Rectangle checkRect = new Rectangle(boxRect.X + 4, boxRect.Y + 4, boxRect.Width - 8, boxRect.Height - 8);
            ...
            {
                Vector2 textPos = new Vector2(boxRect.Right + 10, Bounds.Y + (Bounds.Height - Font.MeasureString(Text).Y) / 2);
